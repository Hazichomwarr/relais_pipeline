...
type KarmdaDirectoryPageProps = {
  searchParams: Promise<{ search?: string }>;
};

/**
 * Canonical KARMDA directory (Ticket 15G.1) — the same school-directory
 * implementation formerly at /schools, relocated here with no logic
 * changes. /schools now redirects to this route to stay backward
 * compatible; /schools/[prospectId] is left untouched (Ticket 15G.2 will
 * decide whether/how to move it).
 */
export default async function KarmdaDirectoryPage({
  searchParams,
}: KarmdaDirectoryPageProps) {
  ...
  const content = (
    <div className="mx-auto max-w-5xl">
      ...
      <form action="/products/karmda" method="GET" className="relative mb-8">
