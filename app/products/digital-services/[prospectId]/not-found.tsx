...
/**
 * Also served for a wrong-product id (Ticket 15G.2) — the copy is
 * intentionally identical to the unknown-id case, so this route never
 * reveals that a prospect exists under a different product.
 */
export default function DigitalServicesSummaryNotFound() {
  return (
