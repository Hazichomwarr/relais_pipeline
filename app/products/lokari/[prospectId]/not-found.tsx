...
/**
 * Also served for a wrong-product id (Ticket 28C, following Digital
 * Services' precedent) — the copy is intentionally identical to the
 * unknown-id case, so this route never reveals that a prospect exists
 * under a different product.
 */
export default function LokariSummaryNotFound() {
  return (
    <main className="flex min-h-screen items-center justify-center bg-[#f5f7fb] px-5 text-slate-800">
      <div className="w-full max-w-lg rounded-4xl border border-slate-200 bg-white p-9 text-center shadow-sm">
        ...
        <p className="mt-3 leading-7 text-slate-500">
          Ce prospect n&apos;existe pas ou a été retiré de la base de
          données.
        </p>
        <Link
          href="/products/lokari"
