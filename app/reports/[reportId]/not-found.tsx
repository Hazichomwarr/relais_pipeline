...
/**
 * Same copy and behavior whether reportId is unknown or belongs to another
 * user — getOwnDailyReportById (Ticket 19A) returns the same not-found
 * result either way, so this page must never hint at which case occurred.
 */
  ...
  return (
    <div className="mx-auto flex max-w-lg flex-col items-center rounded-4xl border border-slate-200 bg-white p-9 text-center shadow-sm">
      ...
      <p className="mt-3 leading-7 text-slate-500">
        Ce rapport n&apos;existe pas ou n&apos;est pas accessible depuis votre
        compte.
      </p>
      <Link
        href="/reports"
