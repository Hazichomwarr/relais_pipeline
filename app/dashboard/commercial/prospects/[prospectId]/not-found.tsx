...
export default function CommercialProspectNotFound() {
  return (
    <main className="flex min-h-[70vh] items-center justify-center bg-[#f5f7fb] px-5 text-slate-800">
      <div className="w-full max-w-lg rounded-4xl border border-slate-200 bg-white p-9 text-center shadow-sm">
        ...
        <p className="mt-3 leading-7 text-slate-500">
          Ce prospect n’existe pas ou ne vous est pas assigné.
        </p>
        <Link
